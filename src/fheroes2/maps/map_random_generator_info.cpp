...
namespace Maps::Random_Generator
{
    ...
    fheroes2::Point Region::adjustRegionToFitCastle( const Map_Format::MapFormat & mapFormat )
    {
        ...
        const int32_t castleX = std::min( std::max( static_cast<int32_t>(startingLocation.x), static_cast<int32_t>(4) ), static_cast<int32_t>(mapFormat.width - 4) );
        const int32_t castleY = std::min( std::max( static_cast<int32_t>(startingLocation.y), static_cast<int32_t>(4) ), static_cast<int32_t>(mapFormat.width - 4) );
